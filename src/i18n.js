                ...
                translation: {
                    ...
                    portfolioCard: {
                        ...
                        description: {
                            ...
                            description12: "Shashlychny calculator - a site for calculating the amount of meat for the holiday.",
                        },
                        "subTitle": "Web-site",
                        "role1": "Developer",
                        "role2": "Designer",
            ...
            uk: {
                translation: {
                    ...
                    portfolioCard: {
                        ...
                        description: {
                            description12: "Шашличний калкулятор - сайт для розрахунку кількості м'яса для свята.",
                    ...
                    InfoPage:{
                        description: {
                            description1: "Я спеціалізуюсь на фронтенд-розробці. Будучи незалежним, я працюю з малими та великими компаніями, стартапами, дизайн-студіями та творчими людьми по всьому світу.",
            ...
            ru: {
                translation: {
                    ...
                    portfolioCard: {
                        ...
                        description: {
                            description12: "Шашлычный калькулятор - сайт для расчета количества мяса на праздник.",
