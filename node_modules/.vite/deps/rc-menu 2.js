...
function genCSSMotion(config) {
  ...
  var CSSMotion = React41.forwardRef(function(props, ref) {
    ...
    var setNodeRef = React41.useCallback(function(node) {
  ...
  var CSSMotionList = function(_React$Component) {
    ...
    _createClass(CSSMotionList2, [{
      ...
      value: function render() {
        ...
        return React42.createElement(Component5, restProps, keyEntities.map(function(_ref2, index2) {
...
function SubMenu(props) {
  ...
  if (measure) {
    ...
    renderNode = React55.createElement(InternalSubMenu, props, childList);
  }
...
var InternalMenuItemGroup = function InternalMenuItemGroup2(_ref) {
  var className = _ref.className, title = _ref.title, eventKey = _ref.eventKey, children = _ref.children, restProps = _objectWithoutProperties(_ref, _excluded12);
  var _React$useContext = React56.useContext(MenuContext), prefixCls = _React$useContext.prefixCls;
  var groupPrefixCls = "".concat(prefixCls, "-item-group");
  return React56.createElement("li", _extends({
    role: "presentation"
  }, restProps, {
    ...
    title: typeof title === "string" ? title : void 0
  }, title), React56.createElement("ul", {
    role: "group",
...
function MenuItemGroup(_ref2) {
  ...
  return React56.createElement(InternalMenuItemGroup, omit(props, ["warnKey"]), childList);
}
...
function Divider(_ref) {
  ...
  return React57.createElement("li", {
    role: "separator",
    className: (0, import_classnames14.default)("".concat(prefixCls, "-item-divider"), className),
    style: style2
  });
}
  ...
  return (list || []).map(function(opt, index2) {
    if (opt && _typeof(opt) === "object") {
      ...
      if (children || type === "group") {
        if (type === "group") {
          return React58.createElement(MenuItemGroup, _extends({
            key: mergedKey
          }, restProps, {
            title: label
          }), convertItemsToNodes(children));
        }
        return React58.createElement(SubMenu, _extends({
          key: mergedKey
        }, restProps, {
          title: label
        }), convertItemsToNodes(children));
      ...
      if (type === "divider") {
        return React58.createElement(Divider, _extends({
          key: mergedKey
        }, restProps));
      }
      return React58.createElement(MenuItem_default, _extends({
        key: mergedKey
      }, restProps), label);
    }
    return null;
...
var Menu = React59.forwardRef(function(props, ref) {
  ...
  var childList = React59.useMemo(function() {
  ...
  var container = React59.createElement(es_default2, _extends({
    ...
    renderRawRest: function renderRawRest(omitItems) {
      ...
      return React59.createElement(SubMenu, {
